...
import com.hyc.springbootinit.model.vo.VideoVO;
...
@Service
public class VideoDataSource implements SearchDataSource<VideoVO>, InitializingBean {
    ...
    public Page<VideoVO> doSearch(String searchText, long pageNum, long pageSize) {
        ...
        // 在搜索之前先GET一遍 https://bilibili.com 以获取cookies
    ...
    public void afterPropertiesSet() {
        SearchAllStrategyFactory.register(SearchTypeEnum.VIDEO.getValue(), this);
    }
}
