...
import com.hyc.springbootinit.mapper.PostFavourMapper;
import com.hyc.springbootinit.mapper.PostMapper;
import com.hyc.springbootinit.mapper.PostThumbMapper;
...
import com.hyc.springbootinit.model.entity.PostFavour;
import com.hyc.springbootinit.model.entity.PostThumb;
...
import com.hyc.springbootinit.utils.SqlUtils;
            ...
            if (postList != null) {
                ...
                postIdList.forEach(postId -> {
                    if (idPostMap.containsKey(postId)) {
                        // 获取es中帖子内容
                        SearchHit<PostEsDTO> hit = highLightMap.get(String.valueOf(postId)).get(0);
                        // 获取高亮内容
                        Map<String, List<String>> highlightFields = hit.getHighlightFields();
                        // 获取数据库中查出来的帖子对象
                        Post post = idPostMap.get(postId).get(0);
                        // 对帖子对象中的内容进行高亮文本替换 如果高亮内容为空 则填充原来的内容
